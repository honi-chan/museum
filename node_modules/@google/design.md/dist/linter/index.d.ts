...
export type { DesignSystemState, ResolvedColor, ResolvedDimension, ResolvedTypography, ResolvedValue, ComponentDef, } from './model/spec.js';
...
export { brokenRef, missingPrimary, contrastCheck, orphanedTokens, tokenSummary, missingSections, missingTypography, unknownKey, tokenLikeIgnored, omitted, } from './linter/rules/index.js';
